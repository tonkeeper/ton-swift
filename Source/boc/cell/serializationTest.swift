...
final class SerializationTest: XCTestCase {
    ...
    func testSerialization() throws {
        ...
        cell = try Builder().storeUint(123456789, bits: 32).endCell()
        ...
        cell = try Builder().storeUint(123456789, bits: 34).endCell()
        ...
        var refCell = try Builder()
            .storeUint(123456789, bits: 32)
            .endCell()
        cell = try Builder()
            .storeUint(987654321, bits: 32)
